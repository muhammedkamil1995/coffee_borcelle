    ...
    <div class="content">
        ...
        <address>
            <p>
                ...
                12, Iduomota Street &middot; lagos island, NG
            </p>
        ...
        <ul class="boxes">
            ...
            <li class="box">
                <h2>Coffee</h2>
                <p class="prices"><span>Small<em>₦2,000</em></span> <span>Large<em>₦4,000</em></span></p>
                <dl>
                    <dt>House Blend</dt>
                    ...
                    <dt>Organic Decaf</dt>
                    <dd class="description">
                        <p>Full-bodied and rich, we promise you won't miss the caffeine.</p>
                    </dd>
                </dl>
            </li>
            ...
            <li class="box">
                ...
                <p class="prices"><span>Small<em>₦3,000</em></span> <span>Large<em>₦5,000</em></span></p>
                <dl>
                    <dt>Machiatto </dt>
                    <dd class="description">
                        <p>Espresso and steamed milk, served in a demitasse cup. <span class="note">(Size Small
                                Only)</span></p>
                    </dd>
                    <dt>Latte</dt>
                    <dd class="description">
                    ...
                    <dt>Mocha</dt>
                    <dd class="description">
                        <p>Espresso with steamed chocolate milk and whipped cream. Also available with white chocolate
                            milk.
                        </p>
                    </dd>
                    <dt>Americano</dt>
            ...
            <li class="box">
                ...
                <p class="prices"><span>Per Cup<em>₦2,500</em></span> <span class="note"><em>₦22,000</em> if you break
                        the
                        cup</span></p>
                <dl>
                    <dt>Earl Grey </dt>
            ...
            <li class="box">
                ...
                <p class="prices"><span>Cookies<em>₦2,900</em></span> <span>Muffins &amp;
                        Pastries<em>₦20,000</em></span>
                </p>
                <dl>
                    <dt>Mallory's Famous Snickerdoodles </dt>
                    <dd class="description">
                        <p>Creamy cinnamony goodness made from scratch with our founder Mallory's prizewinning recipe.
                        </p>
                    </dd>
                    <dt>Oatmeal Cookie</dt>
                    <dd class="description">
                        <p>Packed with rolled oats, raisins, and cranberries, these monster cookies are (almost) good
                            for
                            ya!</p>
                    </dd>
